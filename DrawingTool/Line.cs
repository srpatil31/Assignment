...
namespace DrawingTool
{
    public class Line : CanvasItem
    {
        ...
        {
            //Validation for Colinear points
            //Horizontal or vertical
            if (Coordinate.X2 - Coordinate.X1 == 0 || Coordinate.Y2 - Coordinate.Y1 == 0)
            {
                return true;
            }

            if ((Coordinate.X2 - Coordinate.X1 == Coordinate.Y2 - Coordinate.Y1))
            {
                return true;
